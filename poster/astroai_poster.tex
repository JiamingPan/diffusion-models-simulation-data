...
$\mathrm{sim}$ in pixel, PCA, and SSCD space. Nearest-neighbor plots test
individual copying; reproducibility plots compare the generated distributions
from independently trained runs. Good runs can match statistically without
repeating the same training slices.
